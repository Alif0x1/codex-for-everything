...
if (manifest.version !== "0.3.3") throw new Error("Plugin version must be 0.3.3");
...
if (skillFiles.length !== 20) throw new Error(`Expected 20 skills, found ${skillFiles.length}`);
